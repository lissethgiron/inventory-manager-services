...
class ValidationExceptionControllerTest {
    ...
    void testHandleBadRequestException() {
        Exception.BadRequestException ex = new Exception.BadRequestException("The product no exist");
        ResponseEntity<JsonApiResponse<Object>> response = validationExceptionController.handleBadRequestException(ex);
        assertNotNull(response);
        assertEquals(HttpStatus.BAD_REQUEST, response.getStatusCode());
    }
